...
namespace Lumio\Traits\Localization;
...
trait Locale {
     ...
     * @var string
     */
    public const string NL_NL = 'nl_NL';
     ...
     * @var string
     */
    public const string NO_NO = 'no_NO';
     ...
     * @var string
     */
    public const string FI_FI = 'fi_FI';
     ...
     * @var string
     */
    public const string SK_SK = 'sk_SK';
